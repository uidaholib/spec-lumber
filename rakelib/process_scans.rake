...
# TASK: process_scans
#
# create small and thumb images for image and pdf files in the 'objects/archives/' folder
###############################################################################
...
task :process_scans, [:thumbs_size, :small_size, :density, :missing, :compress_originals, :input_dir] do |_t, args|
  ...
  args.with_defaults(
    ...
    input_dir: 'objects/archives'
  )

  # set the folder locations
  archives_dir = args.input_dir
  objects_dir = 'objects'
